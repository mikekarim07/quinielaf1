...
if usuario_activo is not "Seleccionar":
    ...
    edited_pronosticos = st.data_editor(pronosticos, column_config={"Forecast": st.column_config.SelectboxColumn(options=["Max Verstappen","Carlos Sainz"])}, disabled=["Race No", "Race", "Place", "Fecha", "Player", "Result"], hide_index=True)
