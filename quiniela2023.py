...
if usuario_activo is not "Seleccionar":
    ...
    edited_pronosticos = st.data_editor(pronosticos,"Forecast": st.column_config.SelectboxColumn(label="Pronostico", *, width=None, help="Selecciona de la lista el piloto", width="medium", options=["Max", "Per"]), disabled=["Race No", "Race", "Place", "Fecha", "Player", "Result"], hide_index=False)
