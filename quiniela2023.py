...
if usuario_activo is not "Seleccionar":
    ...
    edited_pronosticos = st.data_editor(pronosticos, column_config={"Forecast": st.column_config.SelectboxColumn(drivers['Piloto'])}, disabled=["Race No", "Race", "Place", "Fecha", "Player", "Result"], hide_index=True)
